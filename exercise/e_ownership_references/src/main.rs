...
// inspect: Is the s String plural or singular?
// Return nothing
fn inspect(s: &String) {
    if s.ends_with('s') {
        println!("{} is plural", s);
...
// change: Change s String to plural if it was singular
// Return nothing
...
// eat: Check if s String start with 'b' and have 'a' in it
// Return bool
...
// bedazzle: Change mut s String into "sparkly"
// Return nothing
